...
const UPCOMING_EVENTS: Event[] = [
  makeEvent(1, 'Tech Conference', 'An exclusive tech conference presented by an American-based company — industry leaders, cutting-edge talks, and hands-on sessions across 2 full days.', 'TBA', 'TBA', 'SN Bose Auditorium, HIT Haldia', 'Technology', 'upcoming', 0, 300, 0, 'Taru Guardians', true, ['conference', 'tech', 'industry']),
  makeEvent(2, 'Figma Craft 3.0', 'A design-focused workshop where you learn to build real products in Figma — from wireframes to high-fidelity prototypes. Open to all skill levels.', 'TBA', 'TBA', 'HIT Haldia Campus', 'Workshop', 'upcoming', 0, 150, 0, 'Taru Guardians', false, ['figma', 'design', 'workshop']),
  makeEvent(3, 'Treasure Hunt 2.0', 'An exciting campus-wide treasure hunt with clues, challenges, and team tasks. Put your minds together and race to the finish.', '2026-05-18', '10:00 AM', 'HIT Haldia Campus', 'Social', 'upcoming', 0, 200, 0, 'Taru Guardians', false, ['treasure-hunt', 'fun', 'campus']),
];
...
const PAST_EVENTS: Event[] = [
  makeEvent(101, 'Quiz-O-Mania 3.0', 'Whether you\'re a quiz enthusiast, a curious learner, or someone who loves the rush of competition — this event is made for you. Organised in collaboration with AlgoZenith HIT Chapter.', '2025-11-02', '10:00 AM', 'Online', 'Technology', 'past', 458, 500, 0, 'Taru Guardians × AlgoZenith HIT Chapter', true, ['quiz', 'competition', 'algozenith']),
  makeEvent(102, 'Abhivyakti', 'An offline non-technical event celebrating expression — featuring Poem/Shayari, Content Writing, Debate, and Quiz competitions. A platform to showcase your voice.', '2025-09-13', '10:00 AM', 'Annex Building, Room 205 & 206', 'Art & Culture', 'past', 80, 100, 0, 'Taru Guardians', false, ['expression', 'debate', 'content-writing']),
  makeEvent(103, 'Pyexpress', 'Step into the world where ideas turn into code! A hands-on Python workshop where creativity meets programming. Build real projects and learn from industry-ready mentors.', '2025-08-17', '01:30 PM', 'CSE Department Ground Floor, HIT Haldia', 'Workshop', 'past', 50, 60, 0, 'Taru Guardians', false, ['python', 'workshop', 'coding']),
  makeEvent(104, 'Taruguardians Tree Plantation Drive', 'Plant Today For a Greener Tomorrow. A hands-on plantation drive by Taru Guardians members inside HIT Haldia campus.', '2025-06-06', '10:00 AM', 'HIT Haldia (Inside Campus)', 'Environment', 'past', 20, 30, 0, 'Taru Guardians', false, ['sustainability', 'plantation', 'green']),
  makeEvent(105, 'GATE & Placement', 'Crack GATE & Placements with Chandan Jha (AVP, GeeksforGeeks) — a free online session packed with preparation strategies, roadmaps, and career guidance.', '2025-03-23', '02:00 PM', 'Virtual', 'Technology', 'past', 350, 400, 0, 'Taru Guardians × GeeksforGeeks', true, ['gate', 'placement', 'tech-talk']),
  makeEvent(106, 'Figma Craft 2.0', 'Design, Collaborate, Create. A comprehensive Figma workshop covering UI/UX fundamentals, component design, and real-world product prototyping at HIT Haldia.', '2025-03-01', '09:30 AM', 'ECE Department, HIT Haldia', 'Workshop', 'past', 100, 120, 0, 'Taru Guardians', false, ['figma', 'design', 'workshop']),
  makeEvent(107, 'Quiz-O-Mania 2.0', 'The second edition of the beloved quiz series — testing your knowledge across tech, general awareness, and logical reasoning in an online format.', '2024-12-16', '11:00 AM', 'Virtual', 'Technology', 'past', 150, 200, 0, 'Taru Guardians', false, ['quiz', 'competition', 'online']),
  makeEvent(108, 'HIT-A-THON 2024', 'Get ready to be part of a high-energy, innovation-packed hackathon! Build solutions, collaborate with the best minds, and compete for exciting prizes at HIT Haldia.', '2024-08-12', '10:00 AM', 'HIT Haldia', 'Technology', 'past', 80, 120, 0, 'Taru Guardians', true, ['hackathon', 'innovation', 'coding']),
  makeEvent(109, 'Tech Talk 2.0 — Bridging the Cloud Gap with AWS', 'Join industry experts for a free online session covering AWS cloud fundamentals, real-world use cases, and career paths in cloud computing. Certificates provided.', '2024-04-21', '01:00 PM', 'Virtual', 'Technology', 'past', 200, 250, 0, 'Taru Guardians', true, ['aws', 'cloud', 'tech-talk']),
  makeEvent(110, 'Tree Plantation Drive', 'A green initiative by Taru Guardians — planting trees at the P5 Hostel Ground of HIT Haldia to contribute to a healthier campus environment.', '2024-03-23', '10:00 AM', 'HIT Haldia (Inside Campus)', 'Environment', 'past', 60, 80, 0, 'Taru Guardians', false, ['sustainability', 'plantation', 'green']),
  makeEvent(111, 'Figma Craft', 'Figma is a powerful web-based design tool. This workshop covered everything from basic UI elements to creating full product mockups — open to all skill levels, conducted online.', '2023-12-09', '11:00 AM', 'Virtual', 'Workshop', 'past', 80, 100, 0, 'Taru Guardians', false, ['figma', 'design', 'workshop']),
  makeEvent(112, 'CodeScape × GeeksforGeeks', 'Put your coding skills to the test! A competitive programming championship organised in collaboration with GeeksforGeeks, held at the Edusat Lab.', '2023-08-17', '10:00 AM', 'Edusat Lab, 2nd Floor, HIT Haldia', 'Technology', 'past', 80, 100, 0, 'Taru Guardians × GeeksforGeeks', false, ['coding', 'competition', 'geeksforgeeks']),
  makeEvent(113, 'Google Summer of Code — Bridging the Gap', 'A comprehensive Tech Talk by Taru Guardians offering full guidance on cracking GSoC — covering eligibility, timelines, proposal writing, and open-source contribution.', '2023-07-30', '10:00 AM', 'Virtual', 'Technology', 'past', 140, 200, 0, 'Taru Guardians', false, ['gsoc', 'open-source', 'tech-talk']),
  makeEvent(114, 'Quiz-O-Mania', 'The inaugural edition of Taru\'s flagship quiz event — a campus quiz competition testing knowledge across technology, science, and general awareness.', '2023-05-15', '10:00 AM', 'Edusat Lab, 2nd Floor, Mechanical Dept', 'Technology', 'past', 180, 200, 0, 'Taru Guardians', true, ['quiz', 'competition', 'campus']),
  makeEvent(115, 'World Water Day — Plantation Drive', 'Taru Guardians celebrated World Water Day by hosting a plantation drive at HIT Haldia\'s P4 Ground, bringing together students for a greener tomorrow.', '2023-03-23', '10:00 AM', 'HIT Haldia P4 Ground', 'Environment', 'past', 180, 200, 0, 'Taru Guardians', false, ['environment', 'plantation', 'world-water-day']),
  makeEvent(116, 'Online Workshop on Crypto Currency', 'A free online workshop on the latest financial trend — covering cryptocurrency basics, trading fundamentals, blockchain technology, and investment risks.', '2022-12-10', '11:00 AM', 'Virtual', 'Workshop', 'past', 100, 150, 0, 'Taru Guardians', false, ['crypto', 'blockchain', 'workshop']),
  makeEvent(117, '30 Days Coding Challenge × Arsh Goyal', 'A month-long coding initiative by Taru Guardians in collaboration with Arsh Goyal — designed to build a consistent coding culture and improve DSA skills across campus.', '2022-10-01', '09:00 AM', 'Virtual', 'Technology', 'past', 80, 120, 0, 'Taru Guardians × Arsh Goyal', false, ['coding', 'dsa', 'challenge']),
  makeEvent(118, 'Taruguardians Tree Plantation Drive', 'We are planting a tree to teach ourselves to gather strength from our deepest roots. A sustainability-focused drive by the Taru Guardians community.', '2022-06-05', '10:00 AM', 'HIT Haldia Campus', 'Environment', 'past', 40, 60, 0, 'Taru Guardians', false, ['sustainability', 'plantation', 'green']),
  makeEvent(119, 'Model Display by Taruguardians', 'Taru Guardians\' first major offline event — a model display themed around World Water Day, showcasing student-built models at the MBA Seminar Hall.', '2022-03-22', '10:00 AM', 'MBA Seminar Hall, IT Dept, 1st Floor', 'Technology', 'past', 110, 150, 0, 'Taru Guardians', true, ['model-display', 'world-water-day', 'campus']),
  makeEvent(120, 'Open-source & GitHub Workshop', 'A free workshop on Open-source and GitHub by Vishal Rajput from NSUT Delhi — top contributors were awarded Scrimba annual subscriptions. An online session for all HIT students.', '2021-06-28', '11:00 AM', 'Virtual', 'Technology', 'past', 95, 120, 0, 'Taru Guardians', false, ['open-source', 'github', 'workshop']),
  makeEvent(121, 'Quiz on Environment', 'An online quiz celebrating World Environment Day — for every 100 participants, Taru Guardians pledged to plant a tree. Knowledge meets action.', '2021-06-01', '07:30 PM', 'Virtual', 'Environment', 'past', 50, 80, 0, 'Taru Guardians', false, ['quiz', 'environment', 'sustainability']),
  makeEvent(122, 'Taruguardians Tree Plantation Drive', 'The founding plantation drive of Taru Guardians — planting trees to build a legacy of environmental responsibility within HIT Haldia.', '2021-03-23', '10:00 AM', 'HIT Haldia Campus', 'Environment', 'past', 30, 50, 0, 'Taru Guardians', false, ['sustainability', 'plantation', 'founding']),
];

...
const FEATURED_EVENTS: FeaturedEvent[] = [
  {
    ...
    date: 'Sun 18 May 2026 · 10:00 AM',
    location: 'HIT Haldia Campus',
    category: 'Social',
  ...
  },
  {
    ...
    date: 'Upcoming · Date TBA',
    location: 'HIT Haldia Campus',
    category: 'Workshop',
    categoryColor: '#F472B6',
    description: 'A design-focused workshop where you learn to build real products in Figma — from wireframes to high-fidelity prototypes. Open to all skill levels.',
    seats: { taken: 0, total: 150 },
    priceLabel: 'Free',
  },
  {
    id: 'e-3',
    ...
    date: 'Upcoming · Date TBA',
    location: 'SN Bose Auditorium, HIT Haldia',
    category: 'Technology',
    categoryColor: '#38BDF8',
    description: 'An exclusive tech conference presented by an American-based company — industry leaders, cutting-edge talks, and hands-on sessions across 2 full days.',
    seats: { taken: 0, total: 300 },
    priceLabel: 'Free',
  },
  {
    id: 'e-4',
    title: 'Quiz-O-Mania 3.0',
    date: 'Sun 2 Nov 2025 · 10:00 AM',
    location: 'Online',
    category: 'Technology',
    categoryColor: '#22C55E',
    description: 'Whether you\'re a quiz enthusiast, a curious learner, or someone who loves competition — this event is for you. Organised with AlgoZenith HIT Chapter.',
    seats: { taken: 458, total: 500 },
    priceLabel: 'Free · Completed',
  },
  {
    id: 'e-5',
    title: 'GATE & Placement Talk',
    date: 'Sun 23 Mar 2025 · 2:00 PM',
    location: 'Virtual',
    category: 'Technology',
    categoryColor: '#FBBF24',
    description: 'Crack GATE & Placements with Chandan Jha (AVP, GeeksforGeeks) — packed with preparation strategies, roadmaps, and career guidance.',
    seats: { taken: 350, total: 400 },
    priceLabel: 'Free · Completed',
  },
  {
    id: 'e-6',
    title: 'HIT-A-THON 2024',
    date: 'Mon 12 Aug 2024 · 10:00 AM',
    location: 'HIT Haldia',
    category: 'Technology',
    categoryColor: '#A78BFA',
    description: 'High-energy, innovation-packed hackathon! Build solutions, collaborate with the best minds, and compete for exciting prizes at HIT Haldia.',
    seats: { taken: 80, total: 120 },
    priceLabel: 'Free · Completed',
  },
];
...
const QUICK_ACTIONS: QuickAction[] = [
  ...
  { id: 'q-mentor', title: 'Find a mentor', subtitle: 'Learn more →', icon: '🧭', color: '#A78BFA' },
...
const IMPACT_METRICS: ImpactMetric[] = [
  {
    ...
    label: 'Haldia',
    value: 'AQI 122',
    caption: 'Summer temp 36°C · 2,400 trees tracked · 48 kg e-waste collected · Industrial port city, high particulate matter in summer.',
    trend: 'down',
    trendPct: 3.2,
    color: '#F97316',
    accent: ['#3E1A00', '#5A2800'],
  },
  {
    id: 'im-2',
    emoji: '🏙️',
    label: 'Kolkata',
    value: 'AQI 156',
    caption: 'Summer temp 38°C · 5,200 trees tracked · 210 kg e-waste collected · Urban heat island effect severe in May–June.',
    trend: 'down',
    trendPct: 5.1,
    color: '#EF4444',
    accent: ['#3F0A0A', '#5C1010'],
  },
  {
    id: 'im-3',
    emoji: '🌾',
    label: 'Medinpur',
    value: 'AQI 88',
    caption: 'Summer temp 36°C · 1,800 trees tracked · 32 kg e-waste collected · Relatively cleaner air, good green cover in rural belt.',
    trend: 'up',
    trendPct: 2.8,
    color: '#4CAF50',
    accent: ['#0A3F10', '#0F5C18'],
  },
  {
    id: 'im-4',
    emoji: '⚙️',
    label: 'Durgapur',
    value: 'AQI 182',
    caption: 'Summer temp 37°C · 1,600 trees tracked · 95 kg e-waste collected · Steel city with heavy industrial emissions year-round.',
    trend: 'down',
    trendPct: 7.4,
    color: '#EF4444',
    accent: ['#3F1A0A', '#5C280F'],
  },
  {
    id: 'im-5',
    emoji: '🏗️',
    label: 'Asansol',
    value: 'AQI 198',
    caption: 'Summer temp 38°C · 1,200 trees tracked · 78 kg e-waste collected · Coal belt region, one of WB\'s most polluted cities.',
    trend: 'down',
    trendPct: 9.1,
    color: '#DC2626',
    accent: ['#3F0A0A', '#600F0F'],
  },
  {
    id: 'im-6',
    emoji: '⚓',
    label: 'Durgachak',
    value: 'AQI 110',
    caption: 'Summer temp 35°C · 840 trees tracked · 22 kg e-waste collected · Port township, coastal breeze helps moderate air quality.',
    trend: 'flat',
    trendPct: 0.5,
    color: '#38BDF8',
    accent: ['#053049', '#0A4A6E'],
  },
  {
    id: 'im-7',
    emoji: '🌿',
    label: 'Panskura',
    value: 'AQI 92',
    caption: 'Summer temp 36°C · 960 trees tracked · 28 kg e-waste collected · Semi-urban town with improving green cover and lower industry.',
    trend: 'up',
    trendPct: 1.9,
    color: '#22C55E',
    accent: ['#0A3F20', '#0F5C2E'],
  },
  {
    id: 'im-8',
    emoji: '🏛️',
    label: 'Bardwan',
    value: 'AQI 158',
    caption: 'Summer temp 38°C · 2,100 trees tracked · 62 kg e-waste collected · Historical city with growing urban pollution and heat stress.',
    trend: 'down',
    trendPct: 4.6,
    color: '#FBBF24',
    accent: ['#3E2B0A', '#5A400F'],
  },
];
...
const LEARNING_PATHS: LearningPath[] = [
  { id: 'lp-1', title: 'Shipping your first article', level: 'starter', hours: 4, owner: 'Content Wing', skills: ['outlining', 'interview notes', 'editor pass'], outcome: 'Learn and grow with Taru Guardians', color: '#F59E0B', emoji: '✍️' },
  { id: 'lp-2', title: 'Mobile UI in React Native', level: 'intermediate', hours: 12, owner: 'Web/App Wing', skills: ['layout + spacing', 'animations', 'ship-ready PR'], outcome: 'Learn and grow with Taru Guardians', color: '#00D4FF', emoji: '📱' },
  { id: 'lp-3', title: 'Brand systems in Figma', level: 'intermediate', hours: 8, owner: 'GD Wing', skills: ['type scale', 'colour tokens', 'component library'], outcome: 'Learn and grow with Taru Guardians', color: '#F472B6', emoji: '🎨' },
  { id: 'lp-4', title: 'From RAW to reel', level: 'starter', hours: 6, owner: 'Photo Wing', skills: ['ingest + cull', 'lightroom grade', 'export ladder'], outcome: 'Learn and grow with Taru Guardians', color: '#7E57C2', emoji: '📷' },
  { id: 'lp-5', title: 'Cutting a 60-sec recap', level: 'intermediate', hours: 10, owner: 'Video Wing', skills: ['story beats', 'sound design', 'captioning'], outcome: 'Learn and grow with Taru Guardians', color: '#FFB74D', emoji: '🎬' },
  { id: 'lp-6', title: 'Getting quoted in press', level: 'advanced', hours: 14, owner: 'PR Wing', skills: ['pitch crafting', 'journalist outreach', 'story angles'], outcome: 'Learn and grow with Taru Guardians', color: '#38BDF8', emoji: '📣' },
];
...
const HomeScreen: React.FC = () => {
      ...
      <View style={styles.quickActionGrid}>
        {QUICK_ACTIONS.slice(0, 6).map((a) => (
          <TouchableOpacity
            ...
            onPress={() => {
              if (a.id === 'q-mentor') {
                Linking.openURL('https://www.taruguardians.club');
              } else if (a.tabTarget) {
                navigation.navigate(a.tabTarget);
              }
            }}
          >
  ...
  const renderImpactDashboard = () => (
    <View style={styles.sectionBlock}>
      <View style={styles.sectionHeaderRow}>
        <Text style={styles.sectionTitle}>🌡️ West Bengal Climate</Text>
        <Text style={styles.sectionCaption}>Summer 2026 · 8 cities</Text>
      </View>
